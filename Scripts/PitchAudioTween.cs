...
namespace mTween {
  ...
  /// Pitch audio tween.
  /// </summary>
  public class PitchAudioTween : AudioTween {
    ...
    public void PitchFrom(float from, float duration, float delay = 0, AnimationCurve curve = null, System.Action OnStart = null, System.Action OnUpdate = null, System.Action OnComplete = null, LoopType loop = null) 
    {
      this.current = from;
      this.from = from;
    ...
    /// <param name="OnComplete">On complete.</param>
    /// <param name="loop">Loop.</param>
    public void PitchTo(float to, float duration, float delay = 0, AnimationCurve curve = null, System.Action OnStart = null, System.Action OnUpdate = null, System.Action OnComplete = null, LoopType loop = null) 
    {
    ...
    protected override void Apply()
    {
      ...
      transform.GetComponent<AudioSource>().pitch = current;
    }
